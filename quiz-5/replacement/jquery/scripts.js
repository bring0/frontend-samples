...
function processPanagram() {
    var checkString = $("#sentence").val();

    var checkPan = new Pangram(checkString);
    ...
    var template = resultTemplate.format(statusClass, checkString, panagramText);
    $("#results").prepend(template);
}


//
// for ie8 compatibility, taken from 
// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/every
//

if (!Array.prototype.every) {
    console.log("IE8 agian...");
